...
class Category(BaseModel):
	...
	category_parent = models.ForeignKey(
		"self", verbose_name='دسته بندی اصلی', null=True, blank=True, related_name='sub_category',
		on_delete=models.SET_DEFAULT,
		default="")
	discount = models.ForeignKey(Discount, related_name='category_discount', verbose_name="تخفیف دسته بندی", on_delete=models.CASCADE, null=True, blank=True)
...
class Product(BaseModel):
	...
	category = models.ForeignKey(Category, verbose_name="دسته بندی محصول", related_name='category_product', on_delete=models.CASCADE)
	...
	def discount_price(self):
		if self.discount.type == 'c':  # نقدی
			return self.price - self.discount.amount
		elif self.discount.type == 'p':  # درصدی
			discount = (self.price * self.discount.amount) / 100
